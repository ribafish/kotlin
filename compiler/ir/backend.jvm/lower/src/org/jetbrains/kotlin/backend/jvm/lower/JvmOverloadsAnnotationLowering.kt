...
internal val _jvmOverloadsAnnotationPhase = makeIrFilePhase(
...
private class JvmOverloadsAnnotationLowering(override val context: JvmBackendContext) : JvmClassLoweringPass {

...
class Fir2IrDeclarationStorage(
    ...
    fun getCachedIrFunctionSymbol(
        ...
        return cachedIrCallable?.let(symbolRemapper::remapFunctionSymbol)
    }
    ...
    fun getCachedIrPropertySymbol(
        ...
        return symbolRemapper.remapPropertySymbol(symbol)
    }
    ...
    fun findGetterOfProperty(propertySymbol: IrPropertySymbol): IrSimpleFunctionSymbol? {
        return getterForPropertyCache[propertySymbol]?.let(symbolRemapper::remapFunctionSymbol)
    }

    fun findSetterOfProperty(propertySymbol: IrPropertySymbol): IrSimpleFunctionSymbol? {
        return setterForPropertyCache[propertySymbol]?.let(symbolRemapper::remapFunctionSymbol)
    }

...
interface KaptExtensionConfig {
     ...
     *
     * Set to `false` only when annotation processors used by this project are suspected of
     * using other sources asides from the task inputs in their processing logic and are not guaranteed to produce the same

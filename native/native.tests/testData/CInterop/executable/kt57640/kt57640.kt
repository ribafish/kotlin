...
//    derived.setDelegate(base) // argument type mismatch, this deserves a diagnostic test
    ...
    assertTrue(delegate16_Bar is BarProtocol)  // compile-time type is inferred as BarProtocol
    ...
    assertTrue(delegate14_Foo is FooProtocol) // compile-time type is inferred as FooProtocol
    ...
    assertTrue(delegate18_Foo is FooProtocol) // compile-time type is inferred as FooProtocol
    ...
    assertTrue(delegate15_Bar is BarProtocol) // compile-time type is inferred as BarProtocol
    ...
    assertTrue(delegate19_Bar is BarProtocol) // compile-time type is inferred as BarProtocol
...
//    derived.setDelegate(base) //  argument type mismatch: actual type is 'library.Base', but 'library.DerivedWithPropertyOverride?' was expected, this deserves a diagnostic test
    ...
    assertTrue(delegate19_Bar is Base)
    assertFalse(delegate19_Bar is FooProtocol)
    assertTrue(delegate19_Bar is BarProtocol) // compile-time type is inferred as FooProtocol

...
public abstract class KtSymbolContainingDeclarationProvider : KtAnalysisSessionComponent() {
    ...
    public abstract fun getContainingJvmClassName(symbol: KtCallableSymbol): FqName?
...
public interface KtSymbolContainingDeclarationProviderMixIn : KtAnalysisSessionMixIn {
    ...
    /**
     * Returns containing JVM class name as [FqName] if any for [KtCallableSymbol]
     *
     ...
     */
    public fun KtCallableSymbol.getContainingJvmClassName(): FqName? =

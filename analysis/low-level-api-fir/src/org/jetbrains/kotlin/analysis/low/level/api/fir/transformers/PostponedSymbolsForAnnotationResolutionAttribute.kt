 ...
 * meet [FirAnnotationCall][org.jetbrains.kotlin.fir.expressions.FirAnnotationCall]'s which are not belonged to us
 ...
 *
 * * Wrong context on call site.
 * It is possible that the annotation can use arguments which are not visible from the call site.
 *
 * @return The collection of [FirBasedSymbol] which have to be resolved on
 ...
 */
internal fun FirBasedSymbol<*>.cannotResolveAnnotationsOnDemand(): Boolean = this is FirCallableSymbol<*> && callableId.isLocal
